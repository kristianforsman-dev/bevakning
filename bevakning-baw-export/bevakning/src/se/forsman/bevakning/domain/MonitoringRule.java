...
public class MonitoringRule {
    ...
    private final String specificDates;
    private final boolean useHistoricalBaseline;
    private final int historicalDays;
    private final int minPercentOfAverage;
    ...
    public MonitoringRule(String id,
        ...
        this.useHistoricalBaseline = useHistoricalBaseline;
        this.historicalDays = historicalDays;
        this.minPercentOfAverage = minPercentOfAverage;
    }
    ...
    public int getMinExpected() { return minExpected; }
    public int getMaxExpected() { return maxExpected; }
    public String getDeadline() { return deadline; }
    public int getWarningMinutesBeforeDeadline() { return warningMinutesBeforeDeadline; }
    public List<MonitoringWindow> getWindows() { return Collections.unmodifiableList(windows); }
    public String getWeekdays() { return weekdays; }
    public String getMonthDays() { return monthDays; }
    public String getSpecificDates() { return specificDates; }
    public boolean isUseHistoricalBaseline() { return useHistoricalBaseline; }
    public int getHistoricalDays() { return historicalDays; }
    public int getMinPercentOfAverage() { return minPercentOfAverage; }
